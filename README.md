...
- Discover devices via its vendors using public API from [macvendors](https://macvendors.com/). Make sure to use your own token if you choose this option to work with!
